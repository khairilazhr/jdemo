...
describe('Book e2e test', () => {
  ...
  it('should create an instance of Book', () => {
    ...
    cy.get(`[data-cy="description"]`).type('deposit', { force: true }).invoke('val').should('match', new RegExp('deposit'));

    cy.get(`[data-cy="publicationDate"]`).type('2024-03-06').should('have.value', '2024-03-06');

    cy.get(`[data-cy="price"]`).type('39873').should('have.value', '39873');
